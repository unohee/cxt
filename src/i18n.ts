...
const en: Messages = {
  ...
  runScanFirst: 'Run `ctx check --scan` first.',
  codeRegistry: 'Code Registry',
  registryEmpty: 'empty',
  runScan: 'Run: ctx check --scan',
  usage: 'Usage:',
  none: 'None',
  ...
  useQualifiedName: 'Use qualified name (file::name) or search with: ctx check --search <query>',
...
const ko: Messages = {
  ...
  runScanFirst: '`ctx check --scan`을 먼저 실행하세요.',
  codeRegistry: '코드 레지스트리',
  registryEmpty: '비어 있음',
  runScan: '실행: ctx check --scan',
  usage: '사용법:',
  none: '없음',
  allTested: '모두 테스트됨',
  codeTree: '코드 트리',
  ...
  useQualifiedName: '정규명(file::name) 또는 ctx check --search <query>로 검색',
